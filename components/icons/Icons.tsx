...
export const ScanIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v1m6 11h2m-6.5 6.5v-1m-6.5-16h-1M4 12H3m16 0h1M4 19h1m15-15l-.707.707M19 19l.707.707M5 5l-.707-.707M5 19l-.707.707" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 9a7 7 0 0114 0v6a7 7 0 01-14 0V9z" />
    </svg>
);
